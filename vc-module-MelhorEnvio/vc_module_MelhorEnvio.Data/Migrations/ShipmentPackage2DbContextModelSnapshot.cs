...
{
    [DbContext(typeof(ShipmentPackage2DbContext))]
    partial class ShipmentPackage2DbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VirtoCommerce.OrdersModule.Data.Model.ShipmentPackageEntity", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("ShipmentPackageEntity");
                });
            ...
            modelBuilder.Entity("vc_module_MelhorEnvio.Data.Model.ShipmentPackage2Entity", b =>
                {
                    b.HasBaseType("VirtoCommerce.OrdersModule.Data.Model.ShipmentPackageEntity");
                    ...
                    b.HasDiscriminator().HasValue("ShipmentPackage2Entity");
                });
