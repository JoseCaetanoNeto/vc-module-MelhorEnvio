...
namespace vc_module_MelhorEnvio.Core
{
    ...
    {
        static readonly Dictionary<string, string> s_countryCodesMapping = new Dictionary<string, string>() {
           { "AFG", "AF" },    // Afghanistan
           { "ALB", "AL" },    // Albania
           { "ARE", "AE" },    // U.A.E.
           { "ARG", "AR" },    // Argentina
        ...
        static public string ConvertThreeCodeToTwoCode(string pThreeLetterISORegionName)
        {
            return s_countryCodesMapping[pThreeLetterISORegionName];
        }
    }
}
